...
export const MainAdminQuestionnaireCardInput = ({
    ...
    return (
        <li className='mainAdminQuestionnaireCardInput'>
            {/* <p className='mainAdminQuestionnaireCardInput__headingId'>{`${id}. `}</p> */}
            <p className='mainAdminQuestionnaireCardInput__heading'>{text}</p>
            <div className='mainAdminQuestionnaireCardInput__input'>
                <InputForm
