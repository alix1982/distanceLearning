...
const Test122 = ({handleNumberQuestion, index, setAnswersTest, answersTest}) => {
    ...
    return (
        <>
            <h3>2-2.	Укажите правильное определение основного понятия «ГРАЖДАНСКАЯ ОБОРОНА»:</h3>
