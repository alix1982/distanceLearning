...
const Test121 = ({handleNumberQuestion, index, setAnswersTest, answersTest}) => {
    ...
    return (
        <>
            <h3>2-1.	Укажите правильное определение основного понятия «ГРАЖДАНСКАЯ ОБОРОНА»:</h3>
