...
const Test131 = ({handleNumberQuestion, index, setAnswersTest, answersTest}) => {
    ...
    return (
        <>
            <h3>3-1.	Укажите правильное определение основного понятия «ГРАЖДАНСКАЯ ОБОРОНА»:</h3>
